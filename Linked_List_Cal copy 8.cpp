...
void UpdateHistory(History* head) {
            History* current = head;
    int position, choice, count = 1;
    std::cout << "Enter the position of the calculation you want to update: ";
    std::cin >> position;
    ...
    std::cout << "Current values: " << current->data->val[0] << " " << current->data->mathOperator << " " << current->data->val[1] << std::endl;

    std::cout << "Enter new value 1: ";
    std::cin >> current->data->val[0];
    std::cout << "Enter new value 2: ";
    std::cin >> current->data->val[1];
    
    choice = MathMenu();
    Computation(choice, current);

    std::cout << "Calculation updated successfully." << std::endl;
}