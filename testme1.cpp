...
void addRecord(Player players[], int &numPlayers) {
...
// Function to view player records
...
// Function to compute the average score of all players
...
// Function to find the player(s) with the max average score
...
int main() {
    const int MaxPlayers = 5; // Maximum number of players
    int numPlayers = 0;
    int option;
